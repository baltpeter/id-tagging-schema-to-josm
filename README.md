...
- British English (`en-GB`): [light mode](https://github.com/baltpeter/id-tagging-schema-to-josm/releases/latest/download/id-presets-en-GB-light.zip), [dark mode](https://github.com/baltpeter/id-tagging-schema-to-josm/releases/latest/download/id-presets-en-GB-dark.zip)
...
- Turkish (`tr`): [light mode](https://github.com/baltpeter/id-tagging-schema-to-josm/releases/latest/download/id-presets-tr-light.zip), [dark mode](https://github.com/baltpeter/id-tagging-schema-to-josm/releases/latest/download/id-presets-tr-dark.zip)
